...
st.subheader("🏦 Lloyds Banking Group (LLOY.L)")
...
with st.spinner("Analysing Lloyds..."):
    prompt = (
        "You are an experienced trading analyst specialising in UK banking stocks. "
        "You are supporting a retail investor monitoring Lloyds Banking Group (LON: LLOY). "
